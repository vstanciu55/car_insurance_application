...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { date_of_incident: @incident.date_of_incident, description: @incident.description, type: @incident.type, value: @incident.value }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { date_of_incident: @incident.date_of_incident, description: @incident.description, type: @incident.type, value: @incident.value }
    assert_redirected_to incident_path(assigns(:incident))
  end
